...
public class Currency {
	...
	public Integer universalValue(Double amount) {
		return (int) (round(amount * rate, 2)*100);
	}
	...
	*/
	public Double valueInThisCurrency(Double otherAmount, Currency othercurrency) {
		return round(otherAmount * othercurrency.getRate() / this.rate, 2);
	}
