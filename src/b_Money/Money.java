...
public class Money implements Comparable {
	...
	public Boolean equals(Money other) {
		Double otherAmountInRate = currency.valueInThisCurrency(other.getAmount(), other.currency);
		return amount.equals(otherAmountInRate);
	}
	...
	public Money add(Money other) {
		Double otherAmountInRate = currency.valueInThisCurrency(other.getAmount(), other.currency);
		return new Money((int)(otherAmountInRate + amount)*100, currency);
	}
	...
	public Money sub(Money other) {
		Double otherAmountInRate = currency.valueInThisCurrency(other.getAmount(), other.currency);
		return new Money((int)(amount - otherAmountInRate)*100, currency);
	}
	 ...
	 */
	public Money negate() {
		return new Money((int)(amount*100) *(-1), currency);
	}
	...
	public int compareTo(Object other) {
		...
		if (other instanceof Money) {
			Money otherCasted = (Money) other;
			int result = (int) ((amount*100) - (currency.valueInThisCurrency(otherCasted.getAmount(), otherCasted.currency) * 100));
