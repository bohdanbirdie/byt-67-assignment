...
//		System.out.println(v1.isOrthogonalTo(v2));
//		System.out.println(v2.isOrthogonalTo(v3));
//		System.out.println(v3.isOrthogonalTo(v4));
//		System.out.println(v4.isOrthogonalTo(v1));
